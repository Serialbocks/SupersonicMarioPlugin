...
extern std::filesystem::path SupersonicMarioPluginDataFolder;
...
#define PRESETS_PATH           (SupersonicMarioPluginDataFolder / "presets")
#define PRO_TIPS_FILE_PATH     (SupersonicMarioPluginDataFolder / "Pro-tips.txt")
...
#define COPIED_MAPS_PATH       (COOKED_PC_CONSOLE_PATH / "supersonicmarioplugin")
...
private:
    ...
    /* Constants Config */
public:
    std::unique_ptr<SMPConfig> ConstantsConfig;
private:
